...
function Contactform(){
	return(
    <React.Fragment>
      <div id="bodyForm" classNameName="bg-light">
        <form classNameName="needs-validation" novalidate="">
          <div classNameName="form-2 ">
            <div classNameName="col-md-8 order-md-1 text-center .mx-auto form">
              <h4 classNameName="mb-3">Billing address</h4>
              <div classNameName="row">
                                <div classNameName="col-md-6 mb-3">
                                    <label for="firstName">First name</label>
                                    <input type="text" classNameName="form-control" id="firstName" placeholder="" value="" required=""/>
                                    <div classNameName="invalid-feedback">
                                    Valid first name is required.</div>
                                </div>
                                <div classNameName="col-md-6 mb-3">
                                    <label for="lastName">Last name</label>
                                    <input type="text" classNameName="form-control" id="lastName" placeholder="" value="" required=""/>
                                    <div classNameName="invalid-feedback">
